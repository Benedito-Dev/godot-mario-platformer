...
# STATE & VARIABLES
# ========================================
enum VisualState { IDLE, WALK, RUNNING, JUMPING, CROUCHING, TURNING, DAMAGE, WALL_SLIDING, FLAG_SLIDING  }
...
func _physics_process(delta: float) -> void:
	...
	if entering_pipe or game_manager.mario_is_respawning or game_manager.mario_is_dead or is_flag_sliding or is_walk_to_castle: 
